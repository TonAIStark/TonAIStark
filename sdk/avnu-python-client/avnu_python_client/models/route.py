...
class Route(BaseModel):
    ...
    address: StrictStr = Field(description="The address of the source")
    percent: Union[StrictFloat, StrictInt] = Field(description="The percentage distribution of sellToken. 1 is 100%")
    ...
    __properties: ClassVar[List[str]] = ["name", "address", "percent", "sellTokenAddress", "buyTokenAddress"]
