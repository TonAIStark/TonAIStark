...
class CreateOrderRequestDtoFrequencyUnitsInner(BaseModel):
    """
    ...
    duration: Optional[CreateOrderRequestDtoFrequencyUnitsInnerDuration] = None
    ...
    __properties: ClassVar[List[str]] = ["durationEstimated", "duration", "timeBased", "dateBased"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "duration": CreateOrderRequestDtoFrequencyUnitsInnerDuration.from_dict(obj["duration"]) if obj.get("duration") is not None else None,
