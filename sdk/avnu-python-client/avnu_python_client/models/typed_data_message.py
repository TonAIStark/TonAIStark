...
class TypedDataMessage(BaseModel):
    ...
    size: StrictInt
    entries: List[TypedDataMessageEntriesInner]
    keys: List[StrictStr]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["content", "values", "isEmpty", "size", "entries", "keys"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "entries": [TypedDataMessageEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "keys": obj.get("keys")
        })
