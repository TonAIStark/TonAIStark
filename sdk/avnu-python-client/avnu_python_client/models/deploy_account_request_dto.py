...
class DeployAccountRequestDto(BaseModel):
    """
    DeployAccountRequestDto
    """ # noqa: E501
    user_address: StrictStr = Field(alias="userAddress")
    deployment_data: DeploymentDataDto = Field(alias="deploymentData")
    __properties: ClassVar[List[str]] = ["userAddress", "deploymentData"]
