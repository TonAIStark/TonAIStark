...
class PageActionDto(BaseModel):
    """
    PageActionDto
    """ # noqa: E501
    content: List[ActionDto]
    size: StrictInt
    number: StrictInt
    total_elements: StrictInt = Field(alias="totalElements")
    total_pages: StrictInt = Field(alias="totalPages")
    __properties: ClassVar[List[str]] = ["content", "size", "number", "totalElements", "totalPages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [ActionDto.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "size": obj.get("size"),
