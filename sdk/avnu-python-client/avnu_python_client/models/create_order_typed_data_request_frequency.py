...
class CreateOrderTypedDataRequestFrequency(BaseModel):
    """
    ...
    units: Optional[List[CreateOrderTypedDataRequestFrequencyUnitsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "units": [CreateOrderTypedDataRequestFrequencyUnitsInner.from_dict(_item) for _item in obj["units"]] if obj.get("units") is not None else None
        })
        return _obj
