...
class CreateOrderRequestDtoFrequencyUnitsInnerDuration(BaseModel):
    """
    CreateOrderRequestDtoFrequencyUnitsInnerDuration
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["seconds", "zero", "nano", "negative"]
