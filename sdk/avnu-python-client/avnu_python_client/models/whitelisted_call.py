...
class WhitelistedCall(BaseModel):
    """
    The list of whitelisted calls
    """ # noqa: E501
    contract_address: StrictStr = Field(description="The value can be '*' if all contracts are whitelisted or can be the contract address (hex format)", alias="contractAddress")
    entrypoint: StrictStr = Field(description="The value can be '*' if all entrypoint are whitelisted or can be the entrypoint name (string format)")
    __properties: ClassVar[List[str]] = ["contractAddress", "entrypoint"]
