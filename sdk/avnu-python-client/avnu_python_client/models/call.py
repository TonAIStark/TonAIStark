...
class Call(BaseModel):
    ...
    """ # noqa: E501
    contract_address: StrictStr = Field(description="Contract's address", alias="contractAddress")
    entrypoint: StrictStr = Field(description="Entrypoint (can be in text format or the selector in hex format)")
    calldata: List[StrictStr] = Field(description="calldata (list of felt)")
