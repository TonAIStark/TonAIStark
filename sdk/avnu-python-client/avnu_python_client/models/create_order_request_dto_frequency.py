...
class CreateOrderRequestDtoFrequency(BaseModel):
    """
    ...
    units: Optional[List[CreateOrderRequestDtoFrequencyUnitsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "units": [CreateOrderRequestDtoFrequencyUnitsInner.from_dict(_item) for _item in obj["units"]] if obj.get("units") is not None else None
        })
        return _obj
