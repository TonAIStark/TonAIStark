...
class ErrorResponse(BaseModel):
    ...
    revert_error: Optional[StrictStr] = Field(default=None, alias="revertError")
    __properties: ClassVar[List[str]] = ["messages", "revertError"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "revertError": obj.get("revertError")
        })
        return _obj
