...
from avnu_python_client.api_response import ApiResponse, T as ApiResponseT
import avnu_python_client.models
from avnu_python_client import rest
from avnu_python_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(avnu_python_client.models, klass)
