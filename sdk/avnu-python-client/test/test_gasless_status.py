...
class TestGaslessStatus(unittest.TestCase):
    """GaslessStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GaslessStatus:
        """Test GaslessStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GaslessStatus`
        """
        model = GaslessStatus()
        if include_optional:
