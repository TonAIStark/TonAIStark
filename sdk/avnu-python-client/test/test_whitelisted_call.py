...
class TestWhitelistedCall(unittest.TestCase):
    """WhitelistedCall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WhitelistedCall:
        """Test WhitelistedCall
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WhitelistedCall`
        """
        model = WhitelistedCall()
        if include_optional:
