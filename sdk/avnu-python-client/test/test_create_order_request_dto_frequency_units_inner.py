...
class TestCreateOrderRequestDtoFrequencyUnitsInner(unittest.TestCase):
    """CreateOrderRequestDtoFrequencyUnitsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrderRequestDtoFrequencyUnitsInner:
        """Test CreateOrderRequestDtoFrequencyUnitsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrderRequestDtoFrequencyUnitsInner`
        """
        model = CreateOrderRequestDtoFrequencyUnitsInner()
        if include_optional:
            return CreateOrderRequestDtoFrequencyUnitsInner(
    ...
    def testCreateOrderRequestDtoFrequencyUnitsInner(self):
        """Test CreateOrderRequestDtoFrequencyUnitsInner"""
