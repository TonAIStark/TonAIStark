...
class TestExecuteSwapRequest(unittest.TestCase):
    """ExecuteSwapRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteSwapRequest:
        """Test ExecuteSwapRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecuteSwapRequest`
        """
        model = ExecuteSwapRequest()
        if include_optional:
    ...
    def testExecuteSwapRequest(self):
        """Test ExecuteSwapRequest"""
