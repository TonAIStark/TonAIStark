...
class TestExecuteSwapResponse(unittest.TestCase):
    """ExecuteSwapResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteSwapResponse:
        """Test ExecuteSwapResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecuteSwapResponse`
        """
        model = ExecuteSwapResponse()
        if include_optional:
    ...
    def testExecuteSwapResponse(self):
        """Test ExecuteSwapResponse"""
